 ...
 * @author usuario
 */
public class ModificarSede2 extends javax.swing.JFrame {
    ...
    private void regresarMenu(){
        ...
        try {
            ...
            Logger.getLogger(ModificarSede2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarSede2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ModificarSede2().setVisible(true);
            }
        });
    }
